...
export const paths = {
  ...
  public: {
    jobApplication: (id) => `${ROOTS.PUBLIC}/job-application/${id}`,
  },
  product: {
    root: `/product`,
  ...
  dashboard: {
    ...
    employee: {
      ...
      details: (id) => `${ROOTS.DASHBOARD}/employee/${id}`,
      edit: (id) => `${ROOTS.DASHBOARD}/employee/${id}/edit`,
    },
    application: {
      root: `${ROOTS.DASHBOARD}/application`,
      new: `${ROOTS.DASHBOARD}/application/new`,
      list: `${ROOTS.DASHBOARD}/application/list`,
      details: (id) => `${ROOTS.DASHBOARD}/application/${id}`,
      edit: (id) => `${ROOTS.DASHBOARD}/application/${id}/edit`,
    },
    tour: {
